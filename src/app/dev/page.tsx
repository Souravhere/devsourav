        ...
        <div className="mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="bg-gray-800 text-gray-100 p-6 rounded-lg shadow-lg border border-gray-700">
            ...
            <div className="flex justify-center space-x-6">
              ...
              <a href="https://github.com/Souravhere" target="_blank" rel="noopener noreferrer" className="text-4xl text--300 hover:text-gray-100 transition-colors duration-300 transform hover:scale-110 hover:rotate-6">
